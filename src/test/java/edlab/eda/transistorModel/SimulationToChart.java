...
public class SimulationToChart {
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        System.out.println(fixedData.get(1));
        ...
        System.out.println(fixedData.size());
        ...
        columnNames = new String[]{"M0.m1:gmoverid","M0.m1:fug","D","B","L","id/w","gds/w","G","M0.m1:vdsat","gmbs/w"};
        //endregion
        ...
        TransistorNNModel tmodel = new TransistorNNModel(metaData, columnNames,new String[]{"M0.m1:fug","id/w","gds/w","gmbs/w"},
            4,.25,0.0001,0.9,0.999,20000,10,fixedData.subList(10001, fixedData.size()));


        File modelSave = new File(baseDir+trainLabel+".bin");


        MultiLayerNetwork savedNetwork = ModelSerializer.restoreMultiLayerNetwork(modelSave);
        savedNetwork.setLearningRate(0.00003);
        tmodel.setModel(savedNetwork);
        tmodel.fitNetworkToInputData(fixedData.subList(0,10000),true,savedNetwork);


        //Fit the nework to the input data, and specify that the training UI is desired
//        tmodel.fitNetworkToInputData(fixedData.subList(0,10000),true);

        //Evaluate the fit of the data on another section of input data
        tmodel.evaluateFit(fixedData.subList(0,10000));

//        Save the model and metadata
        tmodel.saveModelAsFile(baseDir,trainLabel + ".bin","MetaDataReal.txt");
//        endregion
//
        ...
        BufferedWriter br = new BufferedWriter(new FileWriter(baseDir + "simData"+ trainLabel + ".csv"));
...
//                    temp1.add(list);
//                    temp2.add(list.subList(0, tmodel.getNumInputs()));
//                }
//            }
//            sizeSets.add(temp1);
...
//        UseTransistorModel modelUse2 = new UseTransistorModel(baseDir + trainLabel + ".bin");
//
...
//        figure.saveas(baseDir + "Charts/"+trainLabel+"Both.jpeg",1000,800);
//
...
//        figure2.saveas(baseDir + "Charts/"+trainLabel+"Simulated.jpeg",1000,800);
//
...
//        figure3.saveas(baseDir + "Charts/"+trainLabel+"Modeled.jpeg",1000,800);
//        //endregion
//
